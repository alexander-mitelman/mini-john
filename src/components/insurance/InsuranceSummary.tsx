...
export const InsuranceSummary: React.FC<InsuranceSummaryProps> = ({
  ...
  return (
    <section className="items-center shadow-[0px_16px_60px_0px_rgba(67,83,255,0.40)] bg-[linear-gradient(342deg,#4353FF_12.19%,#6A75FF_107.12%)] flex gap-[26px] text-[25px] text-white font-black text-center tracking-[0.27px] leading-[35px] px-4 py-[22px] rounded-[21.864px]">
